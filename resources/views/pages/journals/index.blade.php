            ...
            <table id="journalTable" class="table table-hover table-bordered align-middle mb-0">
                <thead class="table-light">
                    <tr class="text-center">
                        ...
                        <th>Memo</th>
                        <th style="width:10%">Debit Total</th>
                        <th style="width:10%">Credit Total</th>
...
$(function() {
    ...
    let table = $('#journalTable').DataTable({
        ...
        columns: [
            ...
            { data: 'memo' },
            { data: 'debit_total', className: "text-end fw-semibold",
              render: d => (d||0).toLocaleString() },
            { data: 'credit_total', className: "text-end fw-semibold",
              render: d => (d||0).toLocaleString() },
    ...
    $('#journalTable').on('click', '.btn-detail, .btn-edit', function(){
        ...
        $.get("{{ route('ajax.journals.detail', ':id') }}".replace(':id', id), function(res){
            if(res.status==='success'){
                ...
                // TODO: lines bisa ditampilkan di modal jika mau edit detail lines
    ...
    $('#journalForm').submit(function(e){
        ...
        let payload = {
            ...
            memo: $('#memo').val(),
            status: 'posted',
            // Jika ingin tambah lines bisa dikirim di sini
